...
const BlockCSurveyScreen = () => {
    ...
    const getLoadingData = async () => {
        ...
        Axios.get(`https://scslsurvey.online/SCSL-SURVEY/public/api/get-demographic-details`, {
            headers: headers
        })
            .then((response) => {
    ...
    const submitSurvey = async () => {
        ...
        fetch("https://scslsurvey.online/SCSL-SURVEY/public/api/create-survey-section-c", requestOptions)
